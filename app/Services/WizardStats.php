...
class WizardStats
{
    ...
    public static function _getMigrationsQuery($count = false, $start = null, $limit = null, $allData = false): Builder
    {
        ...
        $filterData = self::_getFilterData(new FilterRequest);
     ...
     */
    public static function _getFilterData(FilterRequest $request): array
    {
